...
<body>
    ...
    <form action="validation.php" method="post">
        ...
        <input type="text" name="cognome" id="cognome" pattern="[a-zA-Z'\s]+" required>
        <br>
        <label for="data">Data di nascita*:</label>
        <input type="date" name="data" id="data" required>
        <br>
        <label for="codice_fiscale">Codice fiscale</label>
        <input type="text" name="codice_fiscale" id="codice_f" pattern="[a-zA-Z0-9]{16}" style="text-transform:uppercase">
        <br>
        ...
        <input type="text" name="nCivico" id="n.civico" pattern="[0-9]+" required>
        <br>
